...
def login() -> str:
    ...
    Form data:
      ...
      - password
    Return:
      - JSON payload with the user email and a success message,
        with the session ID set as a cookie
...
def logout() -> str:
    ...
    Return:
      ...
      - 403 if no user is found for the session ID
    """
...
def update_password() -> str:
    ...
    Form data:
      ...
      - new_password
    Return:
      - JSON payload with the email and success message
